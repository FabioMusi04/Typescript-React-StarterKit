        ...
        <div className="w-full md:w-1/2 p-10 space-y-8 flex flex-col justify-center items-center">
          <div className="w-full max-w-xl">
            ...
            <div className="space-y-2 mb-10">
              ...
              <p className="text-secondary dark:text-gray-400">Kindly enter the email address linked to this account and we will send you a code to enable you change your password.</p>
            </div>
